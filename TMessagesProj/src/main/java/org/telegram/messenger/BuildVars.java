...
public class BuildVars {
    ...
    public static String FORK_VERSION_TAG = BuildConfig.FORK_VERSION_TAG;

    public static int APP_ID = 2725571;
    public static String APP_HASH = "0fffbe0c4d5caccab04ac7b674f94a3b";
